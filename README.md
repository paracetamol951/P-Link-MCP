...
- **send_money**: Send an amount of money to a wallet, an email, or a phone number
- **request_payment_link** : getCreate a payment link inorder to be paid the desired amount
